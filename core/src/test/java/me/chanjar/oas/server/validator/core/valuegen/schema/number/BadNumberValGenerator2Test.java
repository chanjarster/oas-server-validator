...
public class BadNumberValGenerator2Test {

  private BadNumberValGenerator2 generator = new BadNumberValGenerator2();
  ...
  public Object[][] testGenerateData() {
    return
        new Object[][] {
            ...
            new Object[] { createSchema2(BigDecimal.ONE, null, null), 1.1D },
            new Object[] { createSchema2(BigDecimal.ONE, true, null), 1D },
            new Object[] { createSchema2(BigDecimal.ONE, false, null), 1.1D },
            ...
            new Object[] { createSchema2(BigDecimal.valueOf(3L), null, BigDecimal.valueOf(2L)), 4D },
            new Object[] { createSchema2(BigDecimal.valueOf(3L), true, BigDecimal.valueOf(2L)), 4D },
            new Object[] { createSchema2(BigDecimal.valueOf(3L), false, BigDecimal.valueOf(2L)), 4D },

            new Object[] { createSchema2(BigDecimal.valueOf(4L), null, BigDecimal.valueOf(2L)), 6D },
            new Object[] { createSchema2(BigDecimal.valueOf(4L), true, BigDecimal.valueOf(2L)), 4D },
            new Object[] { createSchema2(BigDecimal.valueOf(4L), false, BigDecimal.valueOf(2L)), 6D },

            new Object[] { createSchema2(BigDecimal.valueOf(5L), null, BigDecimal.valueOf(2L)), 6D },
            new Object[] { createSchema2(BigDecimal.valueOf(5L), true, BigDecimal.valueOf(2L)), 6D },
            new Object[] { createSchema2(BigDecimal.valueOf(5L), false, BigDecimal.valueOf(2L)), 6D },
  ...
  public void testGenerate(NumberSchema schema, Double expected) {
    assertEquals(
        generator.generate(schema, null).getValue().compareTo(new NumberVal(BigDecimal.valueOf(expected)).getValue()),
        0);
  }
