...
public class FormStyleSchemaValEncoderTest {
  ...
  public void testEmpty(SerializeOption serializeOption, String expected) {
    ...
    FormStyleSchemaValEncoder encoder = new FormStyleSchemaValEncoder();
  ...
  public Object[][] testEncodePrimitiveData() {
    ...
    return new Object[][] {
        ...
        new Object[] { dateTimeVal(), createSerializeOption(true, false),
            "color=2018-12-10T16%3A24%3A15.000%2B08%3A00" },
