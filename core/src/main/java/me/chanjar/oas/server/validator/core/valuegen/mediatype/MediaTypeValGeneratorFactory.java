...
public abstract class MediaTypeValGeneratorFactory {

  private MediaTypeValGeneratorFactory() {
    // singleton
  }

  public static MediaTypeValGenerator goodMediaType() {

    DefaultMediaTypeValGenerator service = new DefaultMediaTypeValGenerator();
  ...
  public static MediaTypeValGenerator badMediaType() {
